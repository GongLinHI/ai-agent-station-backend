...
@Slf4j
@Service
public class ClientMcpToolNode extends AbstractArmorySupport {
    ...
    @Autowired
    public ClientMcpToolNode(Map<String, IParseMcpToolStrategy> parseMcpToolStrategyMap,
    ...
    public StrategyHandler<ArmoryCommand, ArmoryDynamicContext, String> get(
        ...
        if (AiAgentEnum.AI_CLIENT_MCP_TOOL.getCommand().equalsIgnoreCase(commandType)) {
            return cacheNode;
        }
        // 下一个节点
        return advisorNode;
    ...
    public static String getBeanName(String beanId) {
        return AiAgentEnum.AI_CLIENT_MCP_TOOL.getBeanName(beanId);
    }

    public static String getDataName() {
        return AiAgentEnum.AI_CLIENT_MCP_TOOL.getDataName();
    }
}
