...
@Slf4j
@Service
public class AiEmbeddingModelLoadDataStrategy implements ILoadDataStrategy {
    ...
    @Autowired
    public AiEmbeddingModelLoadDataStrategy(IAiAgentRepository aiAgentRepository,
    ...
    public void load(ArmoryCommand armoryCommand,
        ...
        CompletableFuture<List<AiModelEntity>> modelFuture = CompletableFuture.supplyAsync(() -> {
            log.info("基于 {}[{}] 查询[{}]配置", "modelIds", modelIds, "AiEmbeddingModel");
        ...
        try {
            ...
            dynamicContext.setValue(AiAgentEnum.AI_EMBEDDING_MODEL.getDataName(), modelFuture.join());
